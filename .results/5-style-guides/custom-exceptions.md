...
### Location
All custom exceptions live in `Operations.Services/CustomExceptions/`. They are not in `Common` because they are domain-specific and used only by the service layer.
