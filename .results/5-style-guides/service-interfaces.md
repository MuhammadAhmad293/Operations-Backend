...
- Write operations → `Task<ResponseDto<EmptyResponseDto>>`
...
### Location
Service interfaces live in `Operations.IServices/IService/` for domain services and `Operations.IServices/IJob/` for background job services.
